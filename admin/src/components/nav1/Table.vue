	...
	<section>
		...
		<el-col :span="24" class="toolbar">
			<el-form :inline="true" :model="formInline" class="demo-form-inline">
				...
				<el-form-item>
					<el-input v-model="formInline.user" placeholder="车牌号"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<template>
			<el-table :data="tableData" highlight-current-row v-loading="listLoading" style="width: 100%;">
				...
				<el-table-column prop="birth" label="日期" width="180" sortable>
				</el-table-column>
				<el-table-column prop="carcode" label="车牌号" width="160">
				</el-table-column>
				<!--<el-table-column prop="carcode" lable="车牌号" width="100">
				</el-table-column>-->
				<el-table-column prop="addr" label="地址" sortable>
				</el-table-column>
				<el-table-column inline-template :context="_self" label="操作" width="200">
					<span>
						<el-button type="text" size="small" @click="distribution(row)">分配</el-button>
					<el-button type="text" size="small" @click="handleDel(row)">明细</el-button>
		...
		<el-dialog :title="editFormTtile" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="车牌号">
					<el-input type="textarea" v-model="editForm.carcode"></el-input>
				</el-form-item>
			</el-form>
		...
		<!--分配界面-->
		<el-dialog :title="editFormTtile1" v-model="editFormVisible1" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="姓名" prop="name">
					<el-input v-model="editForm.name" auto-complete="off"></el-input>
				</el-form-item>
...
//}
    ...
    methods: {
			...
			distribution:function(row){
				this.editFormVisible=true;
				this.editFormTtile='分配';
				this.editForm.id=row.id;
				this.editForm.name=row.name;
//				this.editForm.sex=row.sex;
//				this.editForm.age=row.age;
				this.editForm.carcode=row.carcode;
				this.editForm.birth=row.birth;
				this.editForm.addr=row.addr;
			},
			//编辑 or 新增
